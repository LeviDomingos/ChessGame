        ...
        if(startPlaying.arraySavePositions.length === 0) {
            ...
            if(player.playerPieces(emoji.pieceEmoji[0], player.playerPieceColor)) {
                if(emoji.pieceEmoji[0] === emoji.piecePlaying.createPieceDetails.blackEmoji[0] | emoji.pieceEmoji[0] === emoji.piecePlaying.createPieceDetails.whiteEmoji[0]) {
                    ...
                    elementEatenPieces.checkWithPawn(emoji.piecePlaying.createPieceDetails.whiteEmoji[0], emoji.piecePlaying.createPieceDetails.blackEmoji[4]);
                    elementEatenPieces.checkWithPawn(emoji.piecePlaying.createPieceDetails.blackEmoji[0], emoji.piecePlaying.createPieceDetails.whiteEmoji[4]);
                } 
                ...
                if(emoji.pieceEmoji[0] === emoji.piecePlaying.createPieceDetails.blackEmoji[1] | emoji.pieceEmoji[0] === emoji.piecePlaying.createPieceDetails.whiteEmoji[1]) {
                    ...
                    elementEatenPieces.checkWithKnight(emoji.piecePlaying.createPieceDetails.whiteEmoji[1], emoji.piecePlaying.createPieceDetails.blackEmoji[4]);
                    elementEatenPieces.checkWithKnight(emoji.piecePlaying.createPieceDetails.blackEmoji[1], emoji.piecePlaying.createPieceDetails.whiteEmoji[4]);
                }
                ...
                if(emoji.pieceEmoji[0] === emoji.piecePlaying.createPieceDetails.blackEmoji[4] | emoji.pieceEmoji[0] === emoji.piecePlaying.createPieceDetails.whiteEmoji[4]) {
                    ...
                    elementEatenPieces.checkWithKing(emoji.piecePlaying.createPieceDetails.whiteEmoji[4], emoji.piecePlaying.createPieceDetails.blackEmoji[4]);
                    elementEatenPieces.checkWithKing(emoji.piecePlaying.createPieceDetails.blackEmoji[4], emoji.piecePlaying.createPieceDetails.whiteEmoji[4]);
                }
                ...
                if(emoji.pieceEmoji[0] === emoji.piecePlaying.createPieceDetails.blackEmoji[2] | emoji.pieceEmoji[0] === emoji.piecePlaying.createPieceDetails.whiteEmoji[2]) {
                    if(startPlaying.moveRookOrQueenForwardAndBack(player.playerPieceColor)) {
                        ...
                        startPlaying.arraySavePositions = [];
                        emoji.pieceEmoji = [];
                        elementEatenPieces.checkWithRookAndQueen(emoji.piecePlaying.createPieceDetails.whiteEmoji[2], emoji.piecePlaying.createPieceDetails.blackEmoji[4])
                        elementEatenPieces.checkWithRookAndQueen(emoji.piecePlaying.createPieceDetails.blackEmoji[2], emoji.piecePlaying.createPieceDetails.whiteEmoji[4])
                    } else {
                ...
                if(emoji.pieceEmoji[0] === emoji.piecePlaying.createPieceDetails.blackEmoji[5] | emoji.pieceEmoji[0] === emoji.piecePlaying.createPieceDetails.whiteEmoji[5]) {
                    if(startPlaying.moveRookOrQueenForwardAndBack(player.playerPieceColor)) {
                        ...
                        startPlaying.arraySavePositions = [];
                        emoji.pieceEmoji =[];
                        elementEatenPieces.checkWithRookAndQueen(emoji.piecePlaying.createPieceDetails.whiteEmoji[5], emoji.piecePlaying.createPieceDetails.blackEmoji[4])
                        elementEatenPieces.checkWithRookAndQueen(emoji.piecePlaying.createPieceDetails.blackEmoji[5], emoji.piecePlaying.createPieceDetails.whiteEmoji[4])
                    } else {
                        if(startPlaying.moveRookOrQueenLeftAndRight(player.playerPieceColor)) {
                            squares[startPlaying.arraySavePositions[0]].innerHTML = "";
                            squares[startPlaying.arraySavePositions[0]].style.backgroundColor = chessBoard.saveColorBackground;
                    ...
                    elementEatenPieces.checkWithQueen(emoji.piecePlaying.createPieceDetails.whiteEmoji[5], emoji.piecePlaying.createPieceDetails.blackEmoji[4]);
                    elementEatenPieces.checkWithQueen(emoji.piecePlaying.createPieceDetails.blackEmoji[5], emoji.piecePlaying.createPieceDetails.whiteEmoji[4]);
                }
                ...
                if(emoji.pieceEmoji[0] === emoji.piecePlaying.createPieceDetails.blackEmoji[3] | emoji.pieceEmoji[0] === emoji.piecePlaying.createPieceDetails.whiteEmoji[3]) {
                    if(startPlaying.moveBishopAndQueenDiagonally(player.playerPieceColor)) {
                        ...
                        startPlaying.arraySavePositions = [];
                        emoji.pieceEmoji = [];
                        elementEatenPieces.getDiagnalPositionForBishopAndQueen(emoji.piecePlaying.createPieceDetails.whiteEmoji[3], emoji.piecePlaying.createPieceDetails.blackEmoji[4])
                        elementEatenPieces.getDiagnalPositionForBishopAndQueen(emoji.piecePlaying.createPieceDetails.blackEmoji[3], emoji.piecePlaying.createPieceDetails.whiteEmoji[4])
